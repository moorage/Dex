...
status = detect_integration("notion", load_mcp_config() or {})
...
| Config write error | "I couldn't update Codex config. Check file permissions at `~/Library/Application Support/Codex/`" |
