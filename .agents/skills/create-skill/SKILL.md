...
**Skill folder:** `.agents/skills/{name}-custom/`
...
- Edit `.agents/skills/{name}-custom/SKILL.md` to modify
```
...
**To edit:** Modify .agents/skills/{name}-custom/SKILL.md
```
...
**Result:**
- Folder: `.agents/skills/board-update-custom/`
