...
These are stored in `.obsidian/` and only affect Obsidian (not Codex/terminal)."
...
You can still use Dex in Codex/terminal exactly as before. Wiki links work everywhere."
