...
_ERROR_PATTERNS = [
    ...
    ("No Dex LLM auth configured", "AI auth missing — run `codex login` or use $ai-setup"),
    ("OPENAI_API_KEY", "AI auth missing — run `codex login` or use $ai-setup"),
    ("ANTHROPIC_API_KEY", "AI auth missing — run `codex login` or use $ai-setup"),
    ("GEMINI_API_KEY", "AI auth missing — run `codex login` or use $ai-setup"),
    ("codex login", "Codex ChatGPT auth missing — run `codex login`"),
